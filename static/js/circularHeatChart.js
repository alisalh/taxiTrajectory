function circularHeatChart() {
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            if (domain === null) {
                var domain_max = d3.max(data, accessor);
                domain = [0, domain_max*0.25, domain_max*0.5, domain_max*0.75 ,domain_max]; //d3.extent(data, accessor);
                autoDomain = true;
            }
